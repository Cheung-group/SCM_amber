...
#include "dprec.h"
   ...
   use evb_parm,  only: bias_ndx, evb_dcrypt, lambda, k_umb, r0_umb &
                      , xch_type, evb_dyn, nevb, nxch, nbias &
                      , dbonds_RC, bond_RC, inc_dbonds_RC, inc_bond_RC &
                      , out_RCdot, egapRC
   use evb_data,  only: evb_Hmat, evb_frc, evb_vel0, evb_bias, RCdot
...
#  include "md.h"
   ...
   _REAL_ , intent(in) :: xf(ndim,nevb), xq(ndim), mass(ndim/3)

   !  ..........................................................................

   integer :: k, l, n, nn, ni, nf, info, idx, jdx, kdx 
   _REAL_  :: evb_vec(nevb,nevb), nrg_evb(nevb)
   _REAL_  :: dr(3), rij, rkj, RC, gradRC(ndim), pi, work(26*nevb) 
...
! #+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#
   ...
   use evb_data, only: evb_frc, evb_vel0, evb_bias, fevb_tmp 
