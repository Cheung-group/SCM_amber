...
#  include "dprec.h"
   ...
   subroutine schlegel_hcn_cart_irc

   use schlegel, only: ndg, ncoord, natm, xdat_min, Bohr2Angstrom
...
#  include "extra.h"
   ...
   integer :: m, xn, zn, io, ios, alloc_error
   _REAL_  , allocatable :: contour(:,:)
   _REAL_  :: xbegin, xend, xincr, zbegin, zend, zincr, toBohr, nrg_tmp(ndg)
   _REAL_  :: V_EVB, dV_EVB(ncoord), ddV_EVB(ncoord*ncoord), q(ncoord), nrg_M1
   _REAL_  , intrinsic :: dble 
   character(512) :: cline
...
!  +---------------------------------------------------------------------------+
   ...
   if( worldrank == 0 ) then
      ...
      open( io, file = "EVB_hcn_cart_irc.nb" )
...
!  x+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++x
   ...
   end subroutine schlegel_hcn_cart_irc
