...
! Qian change, because in amber10, we are not sure whether i or j is larger
...
! Qian change, cap the triple when the force is negative. In addition, change the MAXLIM to 100 in CHI.h
        ...
        write(84,*) '-ixi1,x ', ixi,fxi1_chi,temp_chi,xtriple
        Fxi1_chi=-MAXLIM
        endif
