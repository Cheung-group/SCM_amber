...
# include "amoeba_mpole_index.h"
  public AM_RECIP_perm_field,AM_RECIP_dipole_field,AM_RECIP_ene_frc, &
         AM_RECIP_set_user_bit,AM_RECIP_allocate,AM_RECIP_bcast
  contains
!---------------------------------------------------------
...
!---------------------------------------------------------
subroutine AM_RECIP_dipole_field(numatoms,crd,x,  &
...
#include "def_time.h"
  ...
  call AM_RECIP_field_torque_virial( &
                          numatoms,is_polarizable,nfft1,nfft2,nfft3,recip, &
                          perm_F_field, &
                          r_stack(p_frac_field1),r_stack(p_frac_field2), &
...
subroutine AM_RECIP_get_recip_Gfunc( prefac1,prefac2,prefac3,  &
  ...
  _REAL_  :: pi,fac,mhat1,mhat2,mhat3,msq,denom
...
subroutine AM_RECIP_scalar_sum(recip,ewald_coeff, &
  ...
  integer :: k1,k2,k3,m1,m2,m3,k10,nf1,nf2,nf3,k1s,k2s,k3s,m1s,m2s,m3s
  _REAL_  :: pi,fac,mhat1,mhat2,mhat3,msq,struc2,eterm,vterm, &
