...
subroutine sa_init( verbose, pbprint, natom, atmlast, ifcap, r, rp, rp2, outflag )
...
subroutine sa_driver( verbose,pbprint,natom,atmlast,dosas,ndosas,npbstep,nsaslag,acrd,iar1pb,iprshrt,nex,iex )
   ...
   logical verbose, pbprint
   integer natom, atmlast, dosas, ndosas, npbstep, nsaslag
   ...
   if ( dosas .eq. ndosas) then
      ...
      call sa_arc( verbose, pbprint, atmlast )
   end if
