...
!!   integer, parameter :: MAX_BRD_ITER = 80
!!   integer, parameter :: IMATSZ  = 80
   ...
   logical :: do_scf   ! .false. -> do non-SCC DFTB. Defaul: .true.
...
!!-------------------------------------------------------
   ...
   type dispfile_structure
      _REAL_, dimension(:)  , pointer :: Ni0
      _REAL_, dimension(:,:), pointer :: h1
      _REAL_, dimension(:,:), pointer :: h2
      ...
      _REAL_ , dimension(:,:), pointer :: R0vdw ! (,4)
   ...
   type mol_structure
      ...
      character*2, dimension(:), pointer :: atyp
   ...
   type sktab_structure
      ...
      character(len=1024), dimension(:,:), pointer :: skfiles
      character(len=2 ), dimension(:)  , pointer :: latyp
   ...
   integer, dimension(:), pointer :: lmax !! lmax(qmmm_struct%qm_ntypes): 
                                          !! Max # of orbitals for type "ntype"
