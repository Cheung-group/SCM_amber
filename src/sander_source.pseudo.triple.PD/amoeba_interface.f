...
contains
!-------------------------------------------------------------------------------
subroutine AM_NONBOND_readparm(nf,natom)
  ...
  polar_valid = AM_INDUCED_readparm(nf,natom)
...
!-------------------------------------------------------------------------------
subroutine AMOEBA_readparm(nf,ntf,ntc,numatoms)
   ...
   call AM_NONBOND_readparm(nf,numatoms)
...
subroutine AMOEBA_check_parm_legal(nf)
  ...
  integer :: ier,iok,n,ionerr,indicator
...
!-------------------------------------------------------------------------------
subroutine AM_NonBond_dip_dip_fields(numatoms,crd,x, &
...
# include "ew_parallel.h"
  ...
  call AM_RECIP_dipole_field(numatoms,crd,x,  &
                             ind_dip_d,ind_dip_p,dip_field_d,dip_field_p)
...
# include "ew_parallel.h"
  ...
  call AM_SELF_ene_torque(numatoms,crd,ind_dip_d,ind_dip_p, &
