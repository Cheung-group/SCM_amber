...
#  include "dprec.h"
   ...
   use schlegel,  only: ndg, ncoord, dgdim, b, vkl, dvkl, ddvkl, xdat_xdg &
...
#  include "files.h"
   ...
   integer :: k, l, n, ndx, nstart, nend, alloc_error, dealloc_error, io, ierr
   _REAL_  :: v
   _REAL_  , intrinsic :: reshape
...
#  include "extra.h"
   ...
   integer :: k, l, n, ierr, alloc_error, dealloc_error
   _REAL_  :: v, vkl_sq, vsub, vsqrt
   _REAL_  , intrinsic :: dot_product, sqrt
...
! #+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#
   ...
   subroutine schlegel_vkl ( q, dg_pt )
...
#  include "parallel.h"
   ...
   _REAL_  :: nrg
   _REAL_  , intrinsic :: dot_product, matmul
...
! #+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#
   ...
   use schlegel, only: ndg, dgdim, ncoord, natm, nUFF, vmm, dvmm, ddvmm, dvkl &
                     , ddvkl, b, alpha, gbasis_weight, wdcmat &
...
! #+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#+#
   ...
   deallocate( vmm, dvmm, ddvmm, dvkl, ddvkl, b, wdcmat, alpha &
