...
subroutine pb_directnocut( natom,inatm,ipres,ibgwat,ienwat,ibgion,ienion,ntypes,dbfopt, &
   ...
   integer natom, proatm, inatm, ibgwat, ienwat, ibgion, ienion, ntypes, dbfopt, idecomp, ifcap
