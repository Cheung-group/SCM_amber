...
#  include "def_time.h"
   ...
   if (first) then
      ...
      do 150 i=1,nprot
         ...
         if (nrescur == nrescursave) goto 150
         jres=nter
         if (jres > 0 .and. jres /= nrescur) then
            ncount=ncount+1
      ...
      do 320 j=1,nring
         ...
         if (resat(ip)(6:8) /= 'HEM') then
            ...
            if(namr(j)(4:6) == resat(ip)(11:13) &
                  .and. resat(ip)(3:3) /= '''') goto 320
#else
            if(namr(j)(4:6) == resat(ip)(11:13)) goto 320
#endif
         else
            if(namr(j)(1:3) == 'HEM'  .and. &
                  namr(j)(8:8) == 'H') goto 320
         end if
