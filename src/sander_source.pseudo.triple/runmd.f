...
!        write(72,*)ECHI         does not print anything
!Antonios end
...
!Antonios added:
!        ENER(23)=ENER(23)+ECHI
!        write(72,*)ECHI            only prints once
!Antonios end
...
!Antonios added:
!        ENER(23)=ENER(23)+ECHI
!        write(72,*)"runmd",ENER(23) 
!        write(72,*)"runmd",ECHI Correct for serial 
!Antonios end
...
!         if(master) call mpi_reduce(EHBA,tot_EHBA,1,MPI_DOUBLE_PRECISION, &
!                                    MPI_SUM,0,commmaster,ierr)
#  endif 
      endif
